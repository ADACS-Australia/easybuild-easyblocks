...
class EB_LAPACKDummy(ConfigureMake):
    """
    ...
    def build_step(self):
        ...
        if self.cfg['test_only']:
            ...
            super(EB_LAPACKDummy, self).build_step()
    ...
    def load_module(self, mod_paths=None, purge=True):
        ...
        if not self.cfg['test_only']:
            super(EB_LAPACKDummy, self).load_module(mod_paths=mod_paths, purge=purge)
    ...
    def test_step(self):
        ...
        if self.cfg['test_only']:
            ...
            super(EB_LAPACKDummy, self).test_step()
    ...
    def make_module_step(self, fake=False):
        ...
        if self.cfg['test_only']:
            ...
            return super(EB_LAPACKDummy, self).make_module_step(fake)
    ...
    def sanity_check_step(self):
        ...
        if not self.cfg['test_only']:
            ...
            super(EB_LAPACKDummy, self).sanity_check_step(custom_paths=custom_paths)

LAPACKDummy = EB_LAPACKDummy
